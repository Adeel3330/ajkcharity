<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="px-1 mb-2" style="background-color:rgba(0, 104, 55);">
    <a href="{{ route('admin.dashboard') }}" class="app-brand-link">
      <span>
        <img alt="Punjab Charity Commission" src="{{ url('Images/logo-charity-header.png') }}" width="100%" />
      </span>
    </a>
  </div>
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="auth-login-basic.html" class="menu-link" target="_blank">
              <div class="text-truncate" data-i18n="Basic">Create</div>
            </a>
          </li>
        </ul>
      </li>
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="ui-accordion.html" class="menu-link">
              <div class="text-truncate" data-i18n="Accordion">Create</div>
            </a>
          </li>
        </ul>
      </li>
